...
- **Neutral gray background** — no tint, no opinion
- **Keywords stay quiet** — `if`, `return`, `final` blend in instead of screaming
- **Types and functions are easy to tell apart** — teal vs blue
- **Brighter = more important** — types and definitions pop, strings and numbers sit back
- **Won't fry your eyes** — built for long sessions
